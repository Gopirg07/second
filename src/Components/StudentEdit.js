...
export default function StudentEdit() {
  ...
  const selectedUser = studentdata.find((per) => per.id === id);
  useEffect(() => {
  ...
  const Edit = () => {
    const EditedIndex = studentdata.findIndex((per) => per.id === id);
    ...
    studentdata[EditedIndex] = EditedUser;
